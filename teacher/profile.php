    ...
    <form method="GET" action="profile.php">
        ...
        <div class="student_container">
            <table class="student_profile">
                ...
                <?php
                if (isset($_GET['openprofile'])) {
                    //echo $id;
                    $profile_id = $_GET['profile_id'];
                    $_SESSION['profile_id'] = $profile_id;
                    $queryprofile = "SELECT DISTINCT * FROM student_data WHERE id='$profile_id'";
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td><?php $marks = $row['CNS']+$row['KM']+$row['ECOM']+$row['ISADIE']; echo $marks.'/400';?></td>
                        </tr>
                <?php }
                } ?>
            </table>
                ...
                $(document).ready(function() {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            let total_marks = 400 - ((data[i].CNS)+(data[i].ISADIE)+(data[i].KM)+(data[i].ECOM));
                            var chartdata = {
                                labels: name,
                                datasets: [{
                                    label: 'Marks',
