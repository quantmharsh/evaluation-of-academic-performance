...
<body>
    <div id="main">
    <form method="get" action="edit_s.php" name="myForm" onsubmit="return validate()" class="edit_student">
        ...
        <div class="course">
            <label>Course: </label>
                <select name="course">
                <option name="value" value="<?php echo $row['course']; ?>"><?php echo $row['course']; ?></option>
        ...
        <div class="roll_no">
            <label>Roll_no : </label> <input type="text" value="<?php echo $row['roll_no']; ?>" name="roll_no" />
        </div>
        <div class="attendance">
            <label><?php echo "Attendance in " .$_SESSION['department'].": " ?> </label> <input type="text" value="<?php echo $row['attendance']; ?>%" name="attendance" />
        </div>
        <div>
            <label>CNS marks: </label> <input type="text" value="<?php echo $row['CNS']; ?>" name="CNS" />
        </div>
        <div>
        <label>ISADIE marks: </label> <input type="text" value="<?php echo $row['ISADIE']; ?>" name="ISADIE" />
        </div>
        <div>
        <label>ECOM marks: </label> <input type="text" value="<?php echo $row['ECOM']; ?>" name="ECOM" />
        </div>
        <div>
        <label>KM marks: </label> <input type="text" value="<?php echo $row['KM']; ?>" name="KM" />
        </div>
        <div class="subject_marks">
            <label>Total Marks : </label> <input type="text" value="<?php echo $row['subject_marks']; ?>" name="subject_marks" />
        </div>
    ...
    if (isset($_GET['update'])) {
        ...
        $ISADIE = $_GET['ISADIE'];
        $KM = $_GET['KM'];
        $subject_marks = $_GET['CNS'] + $_GET['ECOM'] + $_GET['ISADIE'] + $_GET['KM'];
        $id = $_GET['id'];
        $query1 = "UPDATE student_data SET s_email ='$s_email', s_name='$s_name', course='$course', roll_no='$roll_no', attendance='$attendance', subject_marks='$subject_marks', CNS='$CNS', ECOM='$ECOM', KM='$KM', ISADIE='$ISADIE' WHERE id='$id'";
